...
# of the array (similar to push() in JavaScript), then add a name to the end of the 
# `friends` array.
...
# The Python method you are looking for is similar to the JavaScript property `.length`.
print("Array length is", len(friends))
